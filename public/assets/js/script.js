...
(function($) {
	...
	$(".prev_btns").on('click', function () {
	  ...
	  if($('.summernote').length > 0) {
		...
		// institutions-slider
		if ($('.eudcation-slider-six').length > 0) {
			$(".eudcation-slider-six").slick({
				lazyLoad: 'ondemand',
				slidesToShow: 3,
				slidesToScroll: 1,
				autoplay: true,
				...
				autoplaySpeed: 1800,
				arrows: true,
				prevArrow: $('.eudcation-prev.arrow-icon'),
				nextArrow: $('.eudcation-next.arrow-icon'),
				responsive: [
					{
						breakpoint: 1400,
						settings: {
		...
		// institutions-slider
		if ($('.minds-slider-six').length > 0) { 
			$(".minds-slider-six").slick({
				lazyLoad: 'ondemand',
				slidesToShow: 4,
				slidesToScroll: 1,
				autoplay: true,
				...
				autoplaySpeed: 1800,
				arrows: true,
				// Using the isax icons from your HTML snippet for consistency
				prevArrow: $('.minds-prev.arrow-icon'),
				nextArrow: $('.minds-next.arrow-icon'),
				responsive: [
					{
						breakpoint: 1400,
						settings: {
		...
		// institutions-slider
		if ($('.review-slider-six').length > 0) { 
			$(".review-slider-six").slick({
				lazyLoad: 'ondemand',
				slidesToShow: 4,
				slidesToScroll: 1,
				autoplay: true,
				...
				arrows: true,
				// Using the isax icons from your HTML snippet for consistency
				prevArrow: $('.slick-prev.arrow-icon'),
				nextArrow: $('.slick-next.arrow-icon'),
				responsive: [
					{
						breakpoint: 1400,
						settings: {
	...
	// institutions-slider
	if ($('.testimonial-slider-nine').length > 0) {
		$(".testimonial-slider-nine").slick({
			lazyLoad: 'ondemand',
			slidesToShow: 1,
			slidesToScroll: 1,
			autoplay: true,
			...
			autoplaySpeed: 1800,
			arrows: true,
			prevArrow: $('.test-prev.arrow-icon'),
			nextArrow: $('.test-next.arrow-icon'),
			responsive: [
				{
					breakpoint: 1400,
					settings: {
	...
	// Aricle Hover
	const items = document.querySelectorAll('.activities-item-six');
		items.forEach(item => {
