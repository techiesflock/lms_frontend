...
const SECTIONS = [
  { id: "watch-sec-1", title: "Html Introduction", lessons: ["Introduction", "What is HTML", "What is a Web page?"] },
  { id: "watch-sec-2", title: "Your First webpage", lessons: ["Introduction", "What is HTML", "What is a Web page?"] },
  { id: "watch-sec-3", title: "Your First webpage", lessons: ["Introduction", "What is HTML", "What is a Web page?"] },
] as const;
            ...
            <div className="col-lg-4 border-end">
              <div className="progress-overview-section">
                ...
                <div className="mb-4">
                  ...
                  <div className="progress progress-xs mb-2" role="progressbar" aria-valuenow={46} aria-valuemin={0} aria-valuemax={100}>
                          ...
                          {sec.lessons.map((name, li) => (
                            ...
                            >
                              <div className="d-flex align-items-center">
                                ...
                                <p className="accordian-content mb-0">{name}</p>
                              </div>
                              <span>2m 10s</span>
                            </div>
                          ))}
